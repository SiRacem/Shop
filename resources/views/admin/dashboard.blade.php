    ...
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                            ...
                            <div class="row align-items-center g-4">
                                <div class="col-12 col-md-auto">
                                    <div class="d-flex align-items-center"><img
                                            src="{{ asset('dashassets/img/icons/illustrations/4.png') }} "
                                ...
                                <div class="col-12 col-md-auto">
                                    <div class="d-flex align-items-center"><img
                                            src="{{ asset('dashassets/img/icons/illustrations/2.png') }} "
                                            alt="" height="46" width="46">
                                        <div class="ms-3">
                                ...
                                <div class="col-12 col-md-auto">
                                    <div class="d-flex align-items-center"><img
                                            src="{{ asset('dashassets/img/icons/illustrations/3.png') }} "
                                            alt="" height="46" width="46">
                                        <div class="ms-3">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h5 class="mb-1">Total orders<span
                                                            class="badge badge-light-warning rounded-pill fs--1 ms-2">-6.8%</span>
                                                    </h5>
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <h5 class="mb-1">New customers<span
                                                            class="badge badge-light-warning rounded-pill fs--1 ms-2">+26.5%</span>
                                                    </h5>
                                                    <h6 class="text-700">Last 7 days</h6>
                                                </div>
                                                <h4>356</h4>
                            ...
                            <div class="col-12 col-md-auto">
                                <div class="row g-2">
                                    ...
                                    <div class="col-auto"><button
                                            class="btn btn-sm btn-phoenix-secondary bg-white hover-bg-100"
                                            type="button">All products</button><button
                                            class="btn btn-sm btn-phoenix-secondary ms-2 bg-white hover-bg-100"
                            ...
                            <table class="table fs--1 mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort border-top align-middle" scope="col" data-sort="rating"
                                            style="min-width:110px;">RATING</th>
                                        <th class="sort border-top align-middle" scope="col"
                                            style="max-width:350px;" data-sort="review">REVIEW</th>
                                        <th class="sort border-top text-start ps-5 align-middle" scope="col"
                                            data-sort="status">STATUS</th>
                                        <th class="sort border-top text-end align-middle" scope="col"
                                            data-sort="time">TIME</th>
                                        <th class="sort border-top text-end pe-0 align-middle" scope="col">ACTION
                                        </th>
                                    </tr>
                                </thead>
                                <tbody class="list" id="table-latest-review-body">
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/1.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Fitbit Sense Advanced Smartwatch with Tools
                                            </h6>
                                        </td>
                                        ...
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">Very helpful to get going with
                                                rapid prototype development. Great support via email when I asked
                                                question.</p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-success">Approved<span
                                                    class="ms-2 fas fa-check"></span></span></td>
                                        ...
                                        <td class="align-middle white-space-nowrap text-end pe-0">
                                            ...
                                            <div class="font-sans-serif btn-reveal-trigger"><button
                                                    class="btn fs--2 btn-sm dropdown-toggle dropdown-caret-none transition-none btn-reveal"
                                                    type="button" data-bs-toggle="dropdown" data-boundary="window"
                                                    aria-haspopup="true" aria-expanded="false"
                                                    data-bs-reference="parent"><span
                                                        class="fas fa-ellipsis-h fs--2"></span></button>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/2.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">iPhone 13 pro max-Pacific Blue-128GB storage
                                            </h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/59.png') }} "
                                                        alt=""></div>
                                        ...
                                        <td class="align-middle rating white-space-nowrap fs--2"><span
                                                ...
                                                class="fa fa-star text-300"></span></td>
                                        <td class="align-middle review" style="min-width:350px;">
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/3.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Apple MacBook Pro 13 inch-M1-8/256GB-space
                                            </h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/58.png') }} "
                                                        alt=""></div>
                                        ...
                                        <td class="align-middle rating white-space-nowrap fs--2"><span
                                                ...
                                                class="fa fa-star text-warning"></span><span
                                                class="fa fa-star text-warning"></span><span
                                                class="fa fa-star-half-alt text-warning star-icon"></span></td>
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">I have started using this
                                                ...
                                                support is second to n...<a href="#!">See more</a></p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-warning">Pending<span
                                                    class="ms-2 fas fa-stopwatch"></span></span></td>
                                        <td class="align-middle text-end time white-space-nowrap">
                                            <div class="hover-hide">
                                                <h6 class="text-1000 mb-0">Just now</h6>
                                            </div>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/4.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Apple iMac 24&quot; 4K Retina Display M1 8
                                                Core CPU...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/avatar-placeholder.png') }} "
                                                        alt=""></div>
                                        ...
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">The best experience we could
                                                ...
                                                products is unsurpas...<a href="#!">See more</a></p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-warning">Pending<span
                                                    class="ms-2 fas fa-stopwatch"></span></span></td>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/5.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Razer kraken V3 X wired 7.1 surround sound
                                                ga....</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                        ...
                                        <td class="align-middle rating white-space-nowrap fs--2"><span
                                                ...
                                                class="fa fa-star text-300"></span></td>
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">Team is very responsive to
                                                inquiries. Love this theme!</p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-warning">Pending<span
                                                    class="ms-2 fas fa-stopwatch"></span></span></td>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/6.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">PlayStation 5 DualSense Wireless Controller
                                            </h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/57.png') }} "
                                                        alt=""></div>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/7.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">2021 Apple 12.9-inch iPad Pro (Wi‑Fi, 128GB)
                                                -...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/3.png') }} "
                                                        alt=""></div>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/8.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Amazon Basics Matte Black Wired Keyboard - US
                                                ...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/26.png') }} "
                                                        alt=""></div>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/9.png') }} " alt=""
                                                width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Amazon Basics Mesh, Mid-Back, Swivel Office
                                                De...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/29.png') }} "
                                                        alt=""></div>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/10.png') }} "
                                                alt="" width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Apple Magic Mouse (Wireless, Rechargable) -
                                                Si...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                        ...
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">This template has allowed me
                                                to convert my existing web app into a great looking, easy to use UI in
                                                less than 2 weeks...<a href="#!">See more</a></p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-success">Approved<span
                                                    class="ms-2 fas fa-check"></span></span></td>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/11.png') }} "
                                                alt="" width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Echo Dot (4th Gen) _ Smart speaker with
                                                Alexa ...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/8.png') }} "
                                                        alt=""></div>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/12.png') }} "
                                                alt="" width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">HORI Racing Wheel Apex for PlayStation 4_3,
                                                an...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                        ...
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">As others mentioned, the team
                                                ...
                                                weekend, fully expec...<a href="#!">See more</a></p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-success">Approved<span
                                                    class="ms-2 fas fa-check"></span></span></td>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/13.png') }} "
                                                alt="" width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Nintendo Switch with Neon Blue and Neon Red
                                                Jo...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/9.png') }} "
                                                        alt=""></div>
                                        ...
                                        <td class="align-middle rating white-space-nowrap fs--2"><span
                                                ...
                                                class="fa fa-star text-warning"></span></td>
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">I had a bit of a hard time at
                                                first but after I contacted the team they were able to help me set up
                                                the theme. It's r...<a href="#!">See more</a></p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-warning">Pending<span
                                                    class="ms-2 fas fa-stopwatch"></span></span></td>
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/14.png') }} "
                                                alt="" width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Oculus Rift S PC-Powered VR Gaming Headset
                                            </h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                        ...
                                        <td class="align-middle product white-space-nowrap py-0"><img
                                                src="{{ asset('dashassets/img//products/15.png') }} "
                                                alt="" width="53"></td>
                                        <td class="align-middle product white-space-nowrap">
                                            <h6 class="fw-semi-bold mb-0">Sony X85J 75 Inch Sony 4K Ultra HD LED Smart
                                                G...</h6>
                                        </td>
                                        <td class="align-middle customer white-space-nowrap"><a
                                                class="d-flex align-items-center" href="#!">
                                                <div class="avatar avatar-l"><img class="rounded-circle"
                                                        src="{{ asset('dashassets/img/team/24.png') }} "
                                                        alt=""></div>
                                        ...
                                        <td class="align-middle rating white-space-nowrap fs--2"><span
                                                ...
                                                class="fa fa-star text-300"></span></td>
                                        <td class="align-middle review" style="min-width:350px;">
                                            <p class="fs--1 fw-semi-bold text-1000 mb-0">This theme is great. Clean
                                                and easy to understand. Perfect for those who don't have time to start
                                                everything from scr...<a href="#!">See more</a></p>
                                        </td>
                                        <td class="align-middle text-start ps-5 status"><span
                                                class="badge fs--1 badge-light-success">Approved<span
                                                    class="ms-2 fas fa-check"></span></span></td>
                        ...
                        <div class="row align-items-center py-1">
                            ...
                            <div class="col d-flex fs--1">
                                <p class="mb-0 d-none d-sm-block me-3 fw-semi-bold text-900" data-list-info></p><a
                                    ...
                                    class="fw-semi-bold d-none" href="#!" data-list-view="less">View Less</a>
                            </div>
                            <div class="col-auto d-flex"><button class="btn btn-link px-1 me-1" type="button"
                                    ...
                                    data-list-pagination="next">Next<span
                                        class="fas fa-chevron-right ms-2"></span></button></div>
                        </div>
                    </div>
                </div>
                <div class="row gx-6">
                    <div class="col-12 col-xl-6">
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0" style="width:32%">
                                            <div class="d-flex align-items-center">
                                                <h6 class="mb-0 me-3">1.</h6><a href="#!">
                                                    <div class="d-flex align-items-center"><img
                                                            src="{{ asset('dashassets/img/country/india.png') }} "
                                                            alt="" width="24">
                                        ...
                                        <td class="align-middle" style="width:17%">
                                            <h6 class="mb-0">92896<span
                                                    class="text-700 fw-medium ms-2">(41.6%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">67<span
                                                    class="text-700 fw-medium ms-2">(34.3%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">$7560<span
                                                    class="text-700 fw-medium ms-2">(36.9%)</span></h6>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0" style="width:32%">
                                            <div class="d-flex align-items-center">
                                                <h6 class="mb-0 me-3">2.</h6><a href="#!">
                                                    <div class="d-flex align-items-center"><img
                                                            src="{{ asset('dashassets/img/country/china.png') }} "
                                                            alt="" width="24">
                                        ...
                                        <td class="align-middle" style="width:17%">
                                            <h6 class="mb-0">50496<span
                                                    class="text-700 fw-medium ms-2">(32.8%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">54<span
                                                    class="text-700 fw-medium ms-2">(23.8%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">$6532<span
                                                    class="text-700 fw-medium ms-2">(26.5%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end pe-0" style="width:17%">
                                            <h6>23.56%</h6>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0" style="width:32%">
                                            <div class="d-flex align-items-center">
                                                <h6 class="mb-0 me-3">3.</h6><a href="#!">
                                                    <div class="d-flex align-items-center"><img
                                                            src="{{ asset('dashassets/img/country/usa.png') }} "
                                                            alt="" width="24">
                                        ...
                                        <td class="align-middle" style="width:17%">
                                            <h6 class="mb-0">45679<span
                                                    class="text-700 fw-medium ms-2">(24.3%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">35<span
                                                    class="text-700 fw-medium ms-2">(19.7%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">$5432<span
                                                    class="text-700 fw-medium ms-2">(16.9%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end pe-0" style="width:17%">
                                            <h6>10.23%</h6>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0" style="width:32%">
                                            <div class="d-flex align-items-center">
                                                <h6 class="mb-0 me-3">4.</h6><a href="#!">
                                                    <div class="d-flex align-items-center"><img
                                                            src="{{ asset('dashassets/img/country/south-korea.png') }} "
                                                            alt="" width="24">
                                                        <p class="mb-0 ps-3 text-primary fw-bold fs--1">South Korea
                                                        </p>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">22<span
                                                    class="text-700 fw-medium ms-2">(9.54%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">$4673<span
                                                    class="text-700 fw-medium ms-2">(11.6%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end pe-0" style="width:17%">
                                            <h6>8.85%</h6>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="white-space-nowrap ps-0" style="width:32%">
                                            <div class="d-flex align-items-center">
                                                <h6 class="mb-0 me-3">5.</h6><a href="#!">
                                                    <div class="d-flex align-items-center"><img
                                                            src="{{ asset('dashassets/img/country/vietnam.png') }} "
                                                            alt="" width="24">
                                        ...
                                        <td class="align-middle" style="width:17%">
                                            <h6 class="mb-0">15007<span
                                                    class="text-700 fw-medium ms-2">(11.9%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">17<span
                                                    class="text-700 fw-medium ms-2">(6.91%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end" style="width:17%">
                                            <h6 class="mb-0">$2456<span
                                                    class="text-700 fw-medium ms-2">(10.2%)</span></h6>
                                        </td>
                                        <td class="align-middle text-end pe-0" style="width:17%">
                                            <h6>6.01%</h6>
                                        </td>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-2 fs--1 mb-1">
                            <p class="mb-0 d-none d-sm-block me-3 fw-semi-bold text-900" data-list-info="">1 to 5
                                <span class="text-600">Items of </span>15
                            </p><a class="fw-semi-bold" href="#!" data-list-view="*">View all<span
                                    class="fas fa-angle-right ms-2" data-fa-transform="down-1"></span></a>
                        </div>
                    </div>
                    <div class="col-12 col-xl-6">
                ...
                <div class="mx-n4 px-4 mx-lg-n6 px-lg-6 bg-white pt-7 pb-6 border-top border-300">
                    <div class="row g-5">
                        <div class="col-12 col-xl-6">
                            <div class="me-xl-4">
                                <div>
