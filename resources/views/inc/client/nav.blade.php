<nav class="navbar navbar-light navbar-top navbar-expand">
    <div class="navbar-logo">
        <button class="btn navbar-toggler navbar-toggler-humburger-icon" type="button"
        ...
        <a class="navbar-brand me-1 me-sm-3"
            ...
            <div class="d-flex align-items-center">
                <div class="d-flex align-items-center"><img
                        src="{{ asset('dashassets/img/icons/logo.png') }} " alt="phoenix"
                        width="32">
                    <p class="logo-text ms-2 d-none d-sm-block">ZVN SHOP</p>
                </div>
            </div>
        </a>
    </div>
    <div class="collapse navbar-collapse">
        ...
        <ul class="navbar-nav navbar-nav-icons ms-auto flex-row">
            <li class="nav-item dropdown">
                <a class="nav-link" id="navbarDropdownNotification" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    <span class="text-700" data-feather="bell" style="height:20px;width:20px;"></span>
                </a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link notification-indicator notification-indicator-primary" id="navbarDropdownSettings" href="#" role="button"
                            ...
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/behance.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/google-cloud.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/slack.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/github.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/bitbucket.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/google-drive.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/trello.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/figma.png') }} "
                                            alt="" width="20">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/twitter.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/pinterest.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/linkedin.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/google-maps.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/google-photos.png') }} "
                                            alt="" width="30">
                                ...
                                <div class="col-4"><a
                                        class="d-block hover-bg-200 p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!" target="_blank"><img
                                            src="{{ asset('dashassets/img/nav-icons/spotify.png') }} "
                                            alt="" width="30">
                        ...
                        <div class="card-body p-0 overflow-auto scrollbar" style="height: 18rem;">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl"><img class="rounded-circle"
                                        src="{{ asset('dashassets/img/team/57.png') }} " alt="">
                                </div>
                                <h6 class="mt-2">{{ Auth::user()->email }}</h6>
                            </div>
                            {{-- <div class="mb-3 mx-3">
                                <input class="form-control form-control-sm" id="statusUpdateInput" placeholder="Update your status">
                            </div> --}}
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item">
                                    <a class="nav-link px-3" href="/client/profile">
                                    <span class="me-2 text-900" data-feather="user"></span>Profile</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <span class="me-2 text-900" data-feather="lock"></span>Posts &amp; Activity</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link px-3" href="#!">
                                    <span class="me-2 text-900" data-feather="settings"></span>Settings &amp; Privacy</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link px-3" href="#!">
